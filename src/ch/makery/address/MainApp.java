...
public class MainApp extends Application {
	 ...
	 * usuário clicar OK, as mudanças são salvas no objeto pessoa fornecido e
	 * retorna true.
	 * 
	 * @param person
	...
	public boolean showPersonEditDialog(Person person) {
		// O main abre o WINDOW_MODAL de edição e passa a pessoa para ser
		// editada retornando o ok ou o cancel
		try {
	 ...
	 * aberto. As preferências são lidas do registro específico do SO. Se tais
	 * preferências não puderem ser encontradas, return null;
	 * 
	 */
	...
	/**
	 * Carrega os dados da pessoa do arquivo especificado. A pessoa atual é
	 * substituida
	 * 
	 * @param file
	 */
	...
	public void showBirthdayStatistics(){
		try{
			...
			//Define a lista de pessoas dentro do controller
